...
proc radula_bootstrap_cross_prepare*() =
  ...
  removeFile(getEnv(RADULA_ENVIRONMENT_DIRECTORY_LOGS) / RADULA_DIRECTORY_CROSS & CurDir & RADULA_DIRECTORY_LOGS)
...
proc radula_bootstrap_system_prepare*() =
  ...
  removeFile(getEnv(RADULA_ENVIRONMENT_DIRECTORY_LOGS) / RADULA_DIRECTORY_SYSTEM & CurDir & RADULA_DIRECTORY_LOGS)
