...
proc radula_behave_bootstrap_cross_environment_teeth*() =
  ...
  putEnv(RADULA_ENVIRONMENT_TOOTH_BUILD_C_COMPILER, RADULA_TOOTH_C_COMPILER)
  putEnv(RADULA_ENVIRONMENT_TOOTH_C_COMPILER, cross_compile & RADULA_TOOTH_C_COMPILER)
  putEnv(RADULA_ENVIRONMENT_TOOTH_C_COMPILER_LINKER, RADULA_TOOTH_C_CXX_COMPILER_LINKER)
  putEnv(RADULA_ENVIRONMENT_TOOTH_C_PREPROCESSOR, cross_compile & RADULA_TOOTH_C_COMPILER & ' ' & RADULA_TOOTH_C_CXX_PREPROCESSOR)
  ...
  putEnv(RADULA_ENVIRONMENT_TOOTH_HOST_C_COMPILER, RADULA_TOOTH_C_COMPILER)
...
proc radula_behave_bootstrap_system_environment_teeth*() =
  ...
  putEnv(RADULA_ENVIRONMENT_TOOTH_BUILD_C_COMPILER, RADULA_TOOTH_C_COMPILER)
  putEnv(RADULA_ENVIRONMENT_TOOTH_C_COMPILER, RADULA_TOOTH_C_COMPILER)
  putEnv(RADULA_ENVIRONMENT_TOOTH_C_COMPILER_LINKER, RADULA_TOOTH_C_CXX_COMPILER_LINKER)
  putEnv(RADULA_ENVIRONMENT_TOOTH_C_PREPROCESSOR, RADULA_TOOTH_C_COMPILER & ' ' & RADULA_TOOTH_C_CXX_PREPROCESSOR)
