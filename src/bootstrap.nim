...
proc radula_bootstrap_release_img*(compress = false) =
  ...
  discard execCmd(&"{RADULA_TOOTH_CHOWN} {RADULA_TOOTH_CHMOD_CHOWN_FLAGS} 20:20 {mount / RADULA_PATH_VAR / RADULA_DIRECTORY_LOGS / RADULA_PATH_WTMPD} {RADULA_TOOTH_SHELL_REDIRECTION}")
...
proc radula_bootstrap_system_environment_directories*() =
  ...
  putEnv(RADULA_ENVIRONMENT_DIRECTORY_TEMPORARY_SYSTEM_BUILDS, RADULA_PATH_RADULA_TEMPORARY / RADULA_DIRECTORY_BUILDS)
  putEnv(RADULA_ENVIRONMENT_DIRECTORY_TEMPORARY_SYSTEM_SOURCES, RADULA_PATH_RADULA_TEMPORARY / RADULA_DIRECTORY_SOURCES)
