...
const
  ...
  RADULA_ENVIRONMENT_DIRECTORY_CACHE_VENOM_SAC* = "SACD"
  ...
  RADULA_ENVIRONMENT_DIRECTORY_TEMPORARY_BUILDS* = "TBLD"
  RADULA_ENVIRONMENT_DIRECTORY_TEMPORARY_SOURCES* = "TSRC"
