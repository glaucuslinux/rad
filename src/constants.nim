...
const
  ...
  RADULA_ENVIRONMENT_DIRECTORY_SYSTEM* = "SYSD"
  ...
  RADULA_ENVIRONMENT_TOOTH_ARCHIVER* = "AR"
  RADULA_ENVIRONMENT_TOOTH_ASSEMBLER* = "AS"
  RADULA_ENVIRONMENT_TOOTH_AUTORECONF* = "AUTORECONF"
  RADULA_ENVIRONMENT_TOOTH_AWK* = "AWK"
  RADULA_ENVIRONMENT_TOOTH_BISON* = "BISON"
  RADULA_ENVIRONMENT_TOOTH_BUILD_C_COMPILER* = "BUILD_CC"
  RADULA_ENVIRONMENT_TOOTH_C_COMPILER* = "CC"
  RADULA_ENVIRONMENT_TOOTH_C_COMPILER_LINKER* = "CC_LD"
  RADULA_ENVIRONMENT_TOOTH_C_PREPROCESSOR* = "CPP"
  RADULA_ENVIRONMENT_TOOTH_CHMOD* = "CHMOD"
  RADULA_ENVIRONMENT_TOOTH_CHOWN* = "CHOWN"
  RADULA_ENVIRONMENT_TOOTH_CXX_COMPILER* = "CXX"
  RADULA_ENVIRONMENT_TOOTH_CXX_COMPILER_LINKER* = "CXX_LD"
  RADULA_ENVIRONMENT_TOOTH_CXX_PREPROCESSOR* = "CXXCPP"
  RADULA_ENVIRONMENT_TOOTH_FLEX* = "FLEX"
  RADULA_ENVIRONMENT_TOOTH_GAWK* = "GAWK"
  RADULA_ENVIRONMENT_TOOTH_HOST_C_COMPILER* = "HOSTCC"
  RADULA_ENVIRONMENT_TOOTH_HOST_CXX_COMPILER* = "HOSTCXX"
  RADULA_ENVIRONMENT_TOOTH_LINKER* = "LD"
  ...
  RADULA_ENVIRONMENT_TOOTH_NAMES* = "NM"
  RADULA_ENVIRONMENT_TOOTH_OBJECT_COPY* = "OBJCOPY"
  RADULA_ENVIRONMENT_TOOTH_OBJECT_DUMP* = "OBJDUMP"
  RADULA_ENVIRONMENT_TOOTH_PATCH* = "PATCH"
  RADULA_ENVIRONMENT_TOOTH_PKG_CONFIG* = "PKG_CONFIG"
  RADULA_ENVIRONMENT_TOOTH_RANDOM_ACCESS_LIBRARY* = "RANLIB"
  RADULA_ENVIRONMENT_TOOTH_READ_ELF* = "READELF"
  RADULA_ENVIRONMENT_TOOTH_RM* = "RM"
  RADULA_ENVIRONMENT_TOOTH_RSYNC* = "RSYNC"
  RADULA_ENVIRONMENT_TOOTH_SIZE* = "SIZE"
  RADULA_ENVIRONMENT_TOOTH_STRINGS* = "STRINGS"
  RADULA_ENVIRONMENT_TOOTH_STRIP* = "STRIP"
...
Distributed under the terms of the ISC License"""
  ...
  RADULA_TOOTH_NAMES* = "gcc-nm"

  RADULA_TOOTH_OBJECT_COPY* = "objcopy"
  RADULA_TOOTH_OBJECT_DUMP* = "objdump"
  ...
  RADULA_TOOTH_STRINGS* = "strings"
  RADULA_TOOTH_STRIP* = "strip"
