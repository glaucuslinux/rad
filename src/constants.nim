...
const
  ...
  RADULA_ENVIRONMENT_TOOTH_RADULA_RSYNC_FLAGS* = "RADULA_RSYNC_FLAGS"
...
Distributed under the terms of the ISC License"""
  ...
  RADULA_TOOTH_TAR_CREATE_FLAGS* = "-cpvf"
  RADULA_TOOTH_TAR_EXTRACT_FLAGS* = "-xmPvf"
