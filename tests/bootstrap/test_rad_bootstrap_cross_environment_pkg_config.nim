...
doAssert getEnv(RAD_ENV_PKG_CONFIG_LIBDIR).endsWith("cross/usr/lib/pkgconfig")
doAssert getEnv(RAD_ENV_PKG_CONFIG_PATH).endsWith("cross/usr/lib/pkgconfig")
doAssert getEnv(RAD_ENV_PKG_CONFIG_SYSROOT_DIR).endsWith("cross/")
doAssert getEnv(RAD_ENV_PKG_CONFIG_SYSTEM_INCLUDE_PATH).endsWith("cross/usr/include")
doAssert getEnv(RAD_ENV_PKG_CONFIG_SYSTEM_LIBRARY_PATH).endsWith("cross/usr/lib")
