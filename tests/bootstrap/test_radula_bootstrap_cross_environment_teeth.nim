...
doAssert getEnv(RADULA_ENVIRONMENT_TOOTH_C_COMPILER_LINKER) == "mold"
...
doAssert getEnv(RADULA_ENVIRONMENT_TOOTH_CXX_COMPILER_LINKER) == "mold"
...
doAssert getEnv(RADULA_ENVIRONMENT_TOOTH_LINKER).endsWith("ld.mold")
