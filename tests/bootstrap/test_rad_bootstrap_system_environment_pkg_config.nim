...
doAssert getEnv(RAD_ENVIRONMENT_PKG_CONFIG_LIBDIR) == "/usr/lib/pkgconfig"
doAssert getEnv(RAD_ENVIRONMENT_PKG_CONFIG_PATH) == "/usr/lib/pkgconfig"
doAssert getEnv(RAD_ENVIRONMENT_PKG_CONFIG_SYSROOT_DIR) == "/"
doAssert getEnv(RAD_ENVIRONMENT_PKG_CONFIG_SYSTEM_INCLUDE_PATH) == "/usr/include"
doAssert getEnv(RAD_ENVIRONMENT_PKG_CONFIG_SYSTEM_LIBRARY_PATH) == "/usr/lib"
