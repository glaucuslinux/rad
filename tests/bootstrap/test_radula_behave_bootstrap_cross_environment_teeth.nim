...
echo "CXXCPP         :: ", getEnv(RADULA_ENVIRONMENT_CROSS_CXX_PREPROCESSOR)
...
doAssert getEnv(RADULA_ENVIRONMENT_CROSS_C_COMPILER_LINKER) == "mold"
...
doAssert getEnv(RADULA_ENVIRONMENT_CROSS_CXX_COMPILER_LINKER) == "mold"
doAssert getEnv(RADULA_ENVIRONMENT_CROSS_CXX_PREPROCESSOR).endsWith("g++ -E")
doAssert getEnv(RADULA_ENVIRONMENT_CROSS_HOST_C_COMPILER) == "gcc"
doAssert getEnv(RADULA_ENVIRONMENT_CROSS_HOST_CXX_COMPILER) == "g++"
doAssert getEnv(RADULA_ENVIRONMENT_CROSS_LINKER).endsWith("ld.mold")
